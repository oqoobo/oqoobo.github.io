...
import{ getFriendslist, addFriend, deletFriend, getCollection} from "./DBController.js";
...
function enterFriendName() {
    ...
    //Datenbank mit allen Usernames notwendig
    //if(Datenbank contains input) => Freund hinzugefügt
    if (input !== null ^ input !== "") {
      alert("Cancelled");
      //return false;
    } else {
